String httpget(String request) {
  ...
  if (request.indexOf("/getValues")>=0) {
    response+=String(wcs1800Data.current,10) + ",";
    response+=String(wcs1800Data.voltage,10) + ",";
    response+=String(wcs1800Data.power,10) + ",";
    response+=String(wcs1800Data.charge,10) + ",";
    response+=String(wcs1800Data.energy,10) + ",";
    response+=String(wcs1800Data.runtime) + ","; }

  else if (request.indexOf("/resetValues")>=0) {
    wcs1800Data.charge=0;
    wcs1800Data.energy=0;
    wcs1800Data.runtime=0; }
